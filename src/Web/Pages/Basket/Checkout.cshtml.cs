    ...
    public class CheckoutModel : PageModel
    {
        ...
        public async Task OnGet()
        {
            if (HttpContext.Request.Query.ContainsKey(Constants.BASKET_ID))
            {
                ...
                await _orderService.CreateOrderAsync(basketId, new Address("Str. Copou nr.66", "Iasi", "Iasi", "Romania", "662643"));
        ...
        public async Task<IActionResult> OnPost(IEnumerable<BasketItemViewModel> items)
        {
            try
            {
                ...
                await _orderService.CreateOrderAsync(BasketModel.Id, new Address("Str. Copou nr.66", "Iasi", "Iasi", "Romania", "662643"));
