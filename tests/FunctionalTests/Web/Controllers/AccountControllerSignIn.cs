...
namespace Microsoft.eShopWeb.FunctionalTests.Web.Controllers
{
    ...
    public class AccountControllerSignIn : IClassFixture<WebTestFixture>
    {
        ...
        public async Task ReturnsSignInScreenOnGet()
        {
            ...
            Assert.Contains("cosmaeduardjtx@gmail.com", stringResponse);
        }
        ...
        public async Task ReturnsSuccessfulSignInOnPostWithValidCredentials()
        {
            ...
            keyValues.Add(new KeyValuePair<string, string>("Email", "cosmaeduardjtx@gmail.com"));
            keyValues.Add(new KeyValuePair<string, string>("Password", "parola"));
